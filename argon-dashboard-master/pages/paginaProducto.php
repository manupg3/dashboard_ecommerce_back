<?php
   ...
   { 
       ...
       $nombreProd = $_SESSION['prod']['nombre']; 
              ...
              <div class="card">
                ...
                <div class="card-body">
                  <form role="form" id="formAgregarProducto" enctype="multipart/form-data">
                    <div class="mb-3">
                      <input type="text" name="nombrePPG" id="nombrePPG" class="form-control form-control-lg" placeholder="" value="<?php echo $nombreProd;?>" aria-label="Nombre">
                    </div>

			...
			<div class="row s_product_inner">
				...
				<div class="col-lg-5 offset-lg-1">
					<div class="s_product_text">
						<input type="hidden" id="id-prod" name="id-prod" value="<?php echo $id; ?>" >
						<h3 id="titulo-prod"><?php echo $titulo; ?></h3>
						<h2 id="precio-prod">$<?php echo $precio; ?></h2>
						<ul class="list">
							<li><a class="active" href="#"><span>Categoria</span> : <?php echo $categoria; ?></a></li>
							<li><a href="#"><span>Stock</span> : <?php echo $stock; ?></a></li>
						</ul>
						<p><?php echo $descripcion; ?></p>
						<div class="product_count">
							<label for="qty">Cantidad:</label>
							<input type="text" name="qty" id="sst" maxlength="12" value="1" title="Quantity:" class="input-text qty">
							<button onclick="incrementQty(<?php echo $precio; ?>);var result = document.getElementById('sst'); var sst = result.value; if( !isNaN( sst )) result.value++;return false;"
							 class="increase items-count" type="button"><i class="lnr lnr-chevron-up"></i></button>
							<button onclick="decrementQty(<?php echo $precio; ?>);var result = document.getElementById('sst'); var sst = result.value; if( !isNaN( sst ) &amp;&amp; sst > 1 ) result.value--;return false;"
							 class="reduced items-count" type="button"><i class="lnr lnr-chevron-down"></i></button>
						</div>
						<div id="card-total" class="d-flex card_area align-items-center">
                               <h3>Total: <h3 id="total-price"></h3></h3>
    					</div>
						
						<div class="card_area d-flex align-items-center">
							<button onclick="addToCart()"; class="primary-btn btn-add-to-cart" id="btn-add-to-cart" href="#">Agregar al carrito</button>
						...
						<div class="col-lg-6">
							<div class="comment_list">
								<div class="review_item">
									<div class="media">
										<div class="d-flex">
											<img class="img-prod" src="img/product/review-1.png" alt="">
										</div>

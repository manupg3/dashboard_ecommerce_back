<?php
 include("crud-ecommerce/traerProductos.php");
 $arrDestacados = [];
 $arrMasVendidos = [];
   foreach ($arrProductos as $producto) {
     if($producto['categoria'] == "Destacados"){

		 array_push($arrDestacados, $producto);

		}
		else if($producto['categoria'] == "Mas Vendidos")
		{
			array_push($arrMasVendidos, $producto);
		}
						...
						<div class="single-product">
							...
							<div class="product-details">
								...
								<input type="hidden" name="id" id="id" value="<?php  echo $producto['id']; ?>">
									<input type="hidden" name="titulo" id="titulo" value="<?php  echo $producto['titulo']; ?>">
		...
		<div class="single-product-slider">
			<div class="container">
				...
				<div class="row">
                   ...
                   foreach ($arrMasVendidos as $producto) {
